...
exports.getProfessorProductTransactions = exports.purchaseProductService = exports.deleteTransaction = exports.updateTransaction = exports.createTransaction = exports.getTransactions = exports.getTransaction = void 0;
...
const getProfessorProductTransactions = async (professorId, page = 1, limit = 10) => {
    const offset = (page - 1) * limit;
    const { rows: transactions, count: total } = await database_1.default.Transaction.findAndCountAll({
        include: [
            {
...
exports.getProfessorProductTransactions = getProfessorProductTransactions;
