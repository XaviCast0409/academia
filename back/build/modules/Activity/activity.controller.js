...
exports.getActivityByProfessorController = exports.changeEvidenceStatusAndAddXavicointsController = exports.getAvailableActivitiesForStudentPaginatedController = exports.deleteActivityController = exports.updateActivityController = exports.createActivityController = exports.getActivitiesController = exports.getActivityController = void 0;
...
const createActivityController = async (req, res) => {
    try {
        const { title, description, xavicoints, images, professorId, difficulty, section, mathTopic } = req.body;
...
const getAvailableActivitiesForStudentPaginatedController = async (req, res) => {
    try {
        ...
        const activities = await (0, activity_service_1.getAvailableActivitiesForStudentPaginated)(Number(studentId), parseInt(page), parseInt(limit), section);
        res.status(200).json(activities);
    }
    catch (error) {
        (0, error_1.errorHelper)(error, res);
...
const getActivityByProfessorController = async (req, res) => {
    try {
        const { professorId } = req.params;
        const { page = 1, pageSize = 10, section } = req.query;
        const result = await (0, activity_service_1.getActivityByProfessor)(Number(professorId), parseInt(page), parseInt(pageSize), section);
...
exports.getActivityByProfessorController = getActivityByProfessorController;
